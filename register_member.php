...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    $sql = "INSERT INTO members (first_name, last_name, email, phone_number, training_plan_id, trainer_id, photo_path, access_card_pdf_path)
    VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    $_SESSION['success_message'] = 'Gym member added';
